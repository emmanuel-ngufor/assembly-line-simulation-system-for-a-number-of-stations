...
{ 
	...
	{ 
	private:
		size_t m_orderID{};                  // order id the order id of the toy (a positive number)
		std::string m_name{};                // the name the name of the toy
		int m_numItems{};                    // the number of items the number of toys of this type to be ordered
		double m_price{};                    // the price the price of this toy
		const double m_HST = 0.13;       // the harmonized sales tax assume the HST is equal to 13% 
